...
rnorm is used to generate a random normally distribured sample. It takes 3 arguments: n, mean, and sd. MASS::mvrnorm produces one or more samples from a multivariate normal distribution and it also takes 3 arguments: n, mu and sigma. To make them more consistent we should use the same names for the arguments. 
